...
class presentationAnimations:
    def __init__(self, lagrange_point_nr,  acceleration_magnitude, alpha, hamiltonian, varying_quantity, orbit_objects, low_dpi,plot_as_x_coordinate,plot_as_family_number):
        ...
        self.figSizeTitle = (2.5 , 2.5*1.5)
        self.figureRatioTitle = (2.5) / (2.5*1.5)
    ...
    def cover_page_picture(self):
        ...
        for lagrange_point_nr in lagrange_point_nrs:
            ax.scatter(lagrange_points_df[lagrange_point_nr]['x'], lagrange_points_df[lagrange_point_nr]['y'],s=10,
                       color='black', marker='x',linewidth=0.5)
...
if __name__ == '__main__':
    ...
    orbit2 = DisplayPeriodicSolutions('horizontal', 2, 0.05, 300.0, -1.525, 'Acceleration', low_dpi, plot_as_x_coordinate, plot_as_family_number)
