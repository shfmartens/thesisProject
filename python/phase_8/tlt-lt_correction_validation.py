...
class TLTLTCorrectorValidation:
    ...
    def plot_tlt_visualization(self):
        ...
        patch_points_df = load_patch_points('../../data/raw/mass_refinement/L' +str(self.lagrangePointNr) + '_' \
        ...
        orbit_df = load_orbit_augmented('../../data/raw/mass_refinement/L' +str(self.lagrangePointNr) + '_' \
                        + str("{:7.6f}".format(self.accelerationMagnitude)) + '_' \
                        + str("{:7.6f}".format(self.alpha)) + '_' + str("{:7.6f}".format(self.amplitude)) \
                        + '_' + str(self.numberOfPatchPoints) + '_' + str("{:7.6f}".format(self.correctionTime)) \
                        + '_0_0_stateHistory.txt')

        # orbit_df_ballistic = load_orbit_augmented('../../data/raw/tlt_corrector/L' + str(self.lagrangePointNr) + '_' \
        #                                 + str("{:7.6f}".format(self.accelerationMagnitude)) + '_' \
        #                                 + str("{:7.6f}".format(self.alpha)) + '_' + str("{:7.6f}".format(self.amplitude)) \
        #                                 + '_' + str(self.numberOfPatchPoints) + '_' + str("{:7.6f}".format(self.correctionTime)) \
        #                                 + '_0_0_stateHistory.txt')
        ...
        #ax1.scatter(orbit_df_ballistic['x'],orbit_df_ballistic['y'],color=self.plottingColors['doubleLine'][0],linewidth=self.lineWidth, label='$\dot{m} = 0$',s=0.1)
        ax1.scatter(orbit_df['x'],orbit_df['y'],color=self.plottingColors['singleLine'],linewidth=self.lineWidth, label='$\dot{m} \\neq 0$',s=0.1)
        ...
        ax1.scatter(patch_points_df['x'], patch_points_df['y'], color='black', marker=self.currentPatchStyle,
                    s=self.patchSize, label='Current patch points')
        ...
        for i in range(1,self.numberOfCycles+1):
            for j in range(1,3):
                ...
                patch_points_df = load_patch_points(
                    '../../data/raw/mass_refinement/L' + str(self.lagrangePointNr) + '_' \
                    + str("{:7.6f}".format(self.accelerationMagnitude)) + '_' \
                    + str("{:7.6f}".format(self.alpha)) + '_' + str("{:7.6f}".format(self.amplitude)) \
                    + '_' + str(self.numberOfPatchPoints) + '_' + str("{:7.6f}".format(self.correctionTime)) \
                ...
                if i == 1 and j == 2:
                    ax3.scatter(orbit_df['x'], orbit_df['y'], color=self.plottingColors['singleLine'],linewidth=self.lineWidth, label='Current guess',s=0.1)
                ...
                if i == 2 and j == 1:
                    ...
                    for row in patch_points_df.iterrows():
                        if row[0] > 0:
                            ...
                            test1 = ax4.annotate("", xy=(x_base, y_base), xytext=(x_end, y_end),
                                             arrowprops=dict(arrowstyle='<-, head_width=1e-1, head_length=2e-1',
                                                             color=self.plottingColors['lambda3'], shrinkA=0, shrinkB=0),label='$V_{'+ 'outgoing'+ '}$')
                    ...
                    for row in propagated_states_df.iterrows():
                        if row[0] > 0:
                            ...
                            test2 = ax4.annotate("", xy=(x_base, y_base), xytext=(x_end, y_end),
                                     arrowprops=dict(arrowstyle='<-, head_width=1e-1, head_length=2e-1',
                                                     color=self.plottingColors['lambda6'], shrinkA=0, shrinkB=0),label='$V_{'+ 'incoming'+ '}$')
                    ...
                    ax4.scatter( -5 ,-5, c=self.plottingColors['lambda3'],marker='$\\longrightarrow$',s=40, label='Outgoing velocity' )
                    ax4.scatter( -5 ,-5, c=self.plottingColors['lambda6'],marker='$\\longrightarrow$',s=40, label='Incoming velocity' )

                    lgd4 = ax2.legend(frameon=True, loc='upper left', bbox_to_anchor=(0, 1), prop={'size': 8})

                if i == 2 and j == 2:
                    ax5.scatter(orbit_df['x'], orbit_df['y'], color=self.plottingColors['singleLine'],linewidth=self.lineWidth, label='Current guess',s=0.1)
                    #ax5.plot(orbit_df_previous['x'], orbit_df_previous['y'], color=self.plottingColors['doubleLine'][0],linewidth=self.lineWidth, linestyle='--', label='Previous guess')

                    ax5.scatter(patch_points_df['x'], patch_points_df['y'], color='black',marker=self.currentPatchStyle, s=self.patchSize, label='Current patch points')
                    ax5.scatter(patch_points_df_previous['x'], patch_points_df_previous['y'], color='black',marker=self.previousPatchStyle, s=self.patchSize, label='Previous patch points')
                ...
                if i == 3 and j == 1:
                    ...
                    for row in patch_points_df.iterrows():
                        if row[0] > 0:
                            ...
                            test1 = ax6.annotate("", xy=(x_base, y_base), xytext=(x_end, y_end),
                                                 arrowprops=dict(arrowstyle='<-, head_width=1e-1, head_length=2e-1',
                    ...
                    for row in propagated_states_df.iterrows():
                        if row[0] > 0:
                            ...
                            test2 = ax6.annotate("", xy=(x_base, y_base), xytext=(x_end, y_end),
                                                 arrowprops=dict(arrowstyle='<-, head_width=1e-1, head_length=2e-1',
                ...
                if i == 3 and j == 2:
                    ax7.scatter(orbit_df['x'], orbit_df['y'], color=self.plottingColors['singleLine'],linewidth=self.lineWidth, label='Current guess',s=0.1)
                    #ax7.plot(orbit_df_previous['x'], orbit_df_previous['y'], color=self.plottingColors['doubleLine'][0],linewidth=self.lineWidth, linestyle='--', label='Previous guess')

                    ax7.scatter(patch_points_df['x'], patch_points_df['y'], color='black',marker=self.currentPatchStyle, s=self.patchSize, label='Current patch points')
                    ax7.scatter(patch_points_df_previous['x'], patch_points_df_previous['y'], color='black',marker=self.previousPatchStyle, s=self.patchSize, label='Previous patch points')
                ...
                if i == 4 and j == 1:
                    ...
                    for row in patch_points_df.iterrows():
                        if row[0] > 0:
                            ...
                            test1 = ax8.annotate("", xy=(x_base, y_base), xytext=(x_end, y_end),
                                                 arrowprops=dict(arrowstyle='<-, head_width=1e-1, head_length=2e-1',
                                                                 color=self.plottingColors['lambda3'], shrinkA=0,
                                                                 shrinkB=0), label='$V_{' + 'outgoing' + '}$')
                    ...
                    for row in propagated_states_df.iterrows():
                        if row[0] > 0:
                            ...
                            test2 = ax8.annotate("", xy=(x_base, y_base), xytext=(x_end, y_end),
                                                 arrowprops=dict(arrowstyle='<-, head_width=1e-1, head_length=2e-1',
                                                                 color=self.plottingColors['lambda6'], shrinkA=0,
                                                                 shrinkB=0), label='$V_{' + 'incoming' + '}$')
                    ...
                    lgd8 = ax8.legend(frameon=True, loc='upper left', bbox_to_anchor=(0, 1), prop={'size': 8})
        ...
        if self.numberOfCycles > 2:
            ax5.set_xlim([(Xmiddle - 0.5 * scaleDistance * self.figureRatio * self.spacingFactor),
            ...
            ax6.set_xlim([(Xmiddle - 0.5 * scaleDistance * self.figureRatio * self.spacingFactor),
                      (Xmiddle + 0.5 * scaleDistance * self.figureRatio * self.spacingFactor)])
            ax6.set_ylim(
            [Ymiddle - 0.5 * scaleDistance * self.spacingFactor, Ymiddle + 0.5 * scaleDistance * self.spacingFactor])
        ...
        if self.numberOfCycles > 3:
            ax7.set_xlim([(Xmiddle - 0.5 * scaleDistance * self.figureRatio * self.spacingFactor),
                      (Xmiddle + 0.5 * scaleDistance * self.figureRatio * self.spacingFactor)])
            ax7.set_ylim(
            [Ymiddle - 0.5 * scaleDistance * self.spacingFactor, Ymiddle + 0.5 * scaleDistance * self.spacingFactor])

            ax8.set_xlim([(Xmiddle - 0.5 * scaleDistance * self.figureRatio * self.spacingFactor),
                      (Xmiddle + 0.5 * scaleDistance * self.figureRatio * self.spacingFactor)])
            ax8.set_ylim(
            [Ymiddle - 0.5 * scaleDistance * self.spacingFactor, Ymiddle + 0.5 * scaleDistance * self.spacingFactor])
        ...
        if self.lowDpi:
            fig.savefig('../../data/figures/mass_refinement/L' + str(self.lagrangePointNr) + '_' \
    ...
    def plot_tlt_sensitivity_analysis(self):
        fig = plt.figure(figsize=(self.figSize[0], self.figSize[1] * 3 / 2))
        ax1 = fig.add_subplot(3, 2, 1)
        ax2 = fig.add_subplot(3, 2, 2)
        ax3 = fig.add_subplot(3, 2, 3)
        ...
        for i in range(len(self.amplitude)):
            ...
            for j in range(len(self.numberOfPatchPoints)):
                ...
                while fileExistence == True:
                    fileExistence = os.path.isfile('../../data/raw/mass_refinement/L' + str(self.lagrangePointNr) + '_' \
                                                   + str("{:7.6f}".format(self.accelerationMagnitude)) + '_' \
                                                   + str("{:7.6f}".format(self.alpha)) + '_' + str(
                        "{:7.6f}".format(self.amplitude[i])) \
                                                   + '_' + str(self.numberOfPatchPoints[j]) + '_' + str(
                        "{:7.6f}".format(self.correctionTime)) \
            ...
            if i == 0:
                ax2.bar(ind, point_influence_df['cycles'], self.widthBar, label='Number of cycles',
                        color=self.plottingColors['lambda6'])

                if max(point_influence_df['cycles']) > max_cycles:
                    max_cycles = max(point_influence_df['cycles'])

                df_min = load_orbit_augmented(
                    '../../data/raw/mass_refinement/L' + str(self.lagrangePointNr) + '_' + str(
            ...
            if i == 1:
                ax4.bar(ind, point_influence_df['cycles'], self.widthBar, label='Number of cycles',
                        color=self.plottingColors['lambda6'])
            ...
            if i == 2:
                ax6.bar(ind, point_influence_df['cycles'], self.widthBar, label='Number of cycles',
                        color=self.plottingColors['lambda6'])

                if max(point_influence_df['cycles']) > max_cycles:
                    max_cycles = max(point_influence_df['cycles'])

                df_min = load_orbit_augmented('../../data/raw/mass_refinement/L' + str(self.lagrangePointNr) + '_' + str(
                    "{:7.6f}".format(self.accelerationMagnitude)) + '_' \
                                              + str("{:7.6f}".format(self.alpha)) + '_' + str(
                    "{:7.6f}".format(self.amplitude[2])) + '_' + str((point_influence_df['patchpoint'][0])) + '_' + str(
                    "{:7.6f}".format(self.correctionTime)) + '_' + str(
                    point_influence_df['cycles'][0]) + '_1_stateHistory.txt')
                ...
                df_max = load_orbit_augmented('../../data/raw/mass_refinement/L' + str(self.lagrangePointNr) + '_' + str(
                    "{:7.6f}".format(self.accelerationMagnitude)) + '_' + str("{:7.6f}".format(self.alpha)) + '_' + str(
                    "{:7.6f}".format(self.amplitude[2])) \
                                              + '_' + str(
                    point_influence_df['patchpoint'][len(point_influence_df) - 1]) + '_' + str(
                    "{:7.6f}".format(self.correctionTime)) \
                                              + '_' + str(
                    point_influence_df['cycles'][len(point_influence_df) - 1]) + '_1_stateHistory.txt')
        ...
        ax1.set_ylim([Ymiddle1 - 0.5 * scaleDistance1 * self.spacingFactor,
                      Ymiddle1 + 0.5 * scaleDistance1 * self.spacingFactor])

        Xmiddle3 = min_x3 + (max_x3 - min_x3) / 2.0
        Ymiddle3 = min_y3 + (max_y3 - min_y3) / 2.0
        scaleDistance3 = max((max_y3 - min_y3), (max_x3 - min_x3))

        ax3.set_xlim([(Xmiddle3 - 0.5 * scaleDistance3 * self.figureRatio * self.spacingFactor),
                      (Xmiddle3 + 0.5 * scaleDistance3 * self.figureRatio * self.spacingFactor)])
        ax3.set_ylim([Ymiddle3 - 0.5 * scaleDistance3 * self.spacingFactor,
        ...
        ax5.set_xlim([(Xmiddle5 - 0.5 * scaleDistance5 * self.figureRatio * self.spacingFactor),
                      (Xmiddle5 + 0.5 * scaleDistance5 * self.figureRatio * self.spacingFactor)])
        ax5.set_ylim([Ymiddle5 - 0.5 * scaleDistance5 * self.spacingFactor,
                      Ymiddle5 + 0.5 * scaleDistance5 * self.spacingFactor])
                    ...
                    for number_of_patch_points in numbers_of_patch_points:
                        for correction_time in correction_times:
                            for number_of_cycles in numbers_of_cycles:
                                tltlt_corrector_validation = TLTLTCorrectorValidation(lagrange_point_nr, orbit_type, acceleration_magnitude, alpha, \
                                                                              amplitude, number_of_patch_points, correction_time, number_of_cycles, low_dpi)


                                tltlt_corrector_validation.plot_tlt_visualization()

                                del tltlt_corrector_validation
