    ...
    def shooting_conditions_analysis(self):
        ...
        if self.varyingQuantity == 'Hamiltonian' or self.varyingQuantity == 'Acceleration':
            ...
            if self.orbitObjects[1].alpha < 59.0:
                ...
                axColorbar = f.add_axes([0.5, colourbar_base, 0.02, colourbar_height])
                axColorbar.get_xaxis().set_visible(False)
                axColorbar.get_yaxis().set_visible(False)
                axColorbar.set_visible(False)
                ...
                lgd = arr[1].legend(frameon=True, loc='center left', bbox_to_anchor=(0.95, 0.83), markerscale=10)
        ...
        #plt.tight_layout()
        plt.subplots_adjust(left=0.065,bottom=0.13,top=0.83,wspace = 0.3,right=0.98)
...
if __name__ == '__main__':
    ...
    if  graphical_projection == True:
        ...
        orbit5 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.05, 300.0, hamiltonian, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit6 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.05, 240.0, hamiltonian, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
