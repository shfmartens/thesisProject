...
if __name__ == '__main__':
    ...
    if  graphical_projection == True:
        ...
        orbit5 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.01, 300.0, hamiltonian, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit6 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.01, 240.0, hamiltonian, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
