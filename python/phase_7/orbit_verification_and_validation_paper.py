...
if __name__ == '__main__':
    ...
    if  graphical_projection == True:
        ...
        # orbit7 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, acceleration_magnitude, alpha, -1.55, varying_quantity, low_dpi, plot_as_x_coordinate, plot_as_family_number)
        # orbit8 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, acceleration_magnitude, alpha, -1.525,varying_quantity, low_dpi, plot_as_x_coordinate, plot_as_family_number)
        # orbit9 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, acceleration_magnitude, alpha, -1.50,varying_quantity, low_dpi, plot_as_x_coordinate, plot_as_family_number)
