...
if __name__ == '__main__':
    ...
    if  graphical_projection == True:
        ...
        orbit1 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.01, 0.0, -1.55, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit2 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.01, 60.0, -1.525, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit3 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.01, 120.0, -1.50, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit4 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.05, 180.0, -1.55, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit5 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.05, 300.0, -1.525, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit6 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.05, 240.0, -1.50, varying_quantity, low_dpi,plot_as_x_coordinate,plot_as_family_number)
        orbit7 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.1, alpha, -1.55, varying_quantity, low_dpi, plot_as_x_coordinate, plot_as_family_number)
        orbit8 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.1, alpha, -1.525,varying_quantity, low_dpi, plot_as_x_coordinate, plot_as_family_number)
        orbit9 = DisplayPeriodicSolutions('horizontal', lagrange_point_nr, 0.1, alpha, -1.50,varying_quantity, low_dpi, plot_as_x_coordinate, plot_as_family_number)
