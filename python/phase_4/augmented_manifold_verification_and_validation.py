...
#        fig.savefig('/Users/koen/Documents/Courses/AE5810 Thesis Space/Meetings/0901/L' + str(self.lagrangePointNr) + '_' + self.orbitType + '_' + str(self.orbitId) + '_eigenvector_subplots.png')
    ...
    def plot_iom_validation(self):
        ...
        #
        # ylim = [min(arr[1, 0].get_ylim()[0], arr[2, 0].get_ylim()[0], arr[1, 1].get_ylim()[0], arr[2, 1].get_ylim()[0]),
        #         max(arr[1, 0].get_ylim()[1], arr[2, 0].get_ylim()[1], arr[1, 1].get_ylim()[1], arr[2, 1].get_ylim()[1])]
        #
        # for i in range(1, 3):
        #     for j in range(2):
