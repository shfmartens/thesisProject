...
class SpatialManifoldsZoomAnimation:
    ...
    def animate(self):
        ...
        title = self.orbitTypeForTitle + ' $\{ \mathcal{W}^{S \pm}, \mathcal{W}^{U \pm} \}$ - Spatial overview at C = ' + str(self.cLevel)
        ...
        file_name = '../../../data/animations/manifolds/spatial_manifolds_zoom_' + self.orbitType + '_' + str(self.cLevel) + '.mp4'
