...
class PlanarManifoldsAnimation:
    ...
    def animate(self):
        ...
        self.timeText = ax.text(0.05, 0.05, s='$\|t\| \\approx 0$', transform=ax.transAxes, size=self.timeTextSize)
        ...
        for lagrange_point_nr in lagrange_point_nrs:
            plt.scatter(lagrange_points_df[lagrange_point_nr]['x'], lagrange_points_df[lagrange_point_nr]['y'],
        ...
        file_name = '../../../data/animations/manifolds/planar_manifolds_' + orbit_type + '_' + str(c_level) + '.mp4'
