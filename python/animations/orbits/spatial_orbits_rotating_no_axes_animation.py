...
class SpatialOrbitsRotatingNoAxesAnimation:
    ...
    def animate(self):
        ...
        file_name = '../../../data/animations/orbits/spatial_orbits_rotating_no_axes_' + str(self.cLevel) + '.mp4'
...
if __name__ == '__main__':
    ...
    for c_level in c_levels:
        spatial_orbits_rotating_no_axes_animation = SpatialOrbitsRotatingNoAxesAnimation(c_level, orbit_ids)
        spatial_orbits_rotating_no_axes_animation.animate()
