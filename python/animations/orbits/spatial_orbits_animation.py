...
class SpatialOrbitsAnimation:
    ...
    def animate(self):
        ...
        title = 'Types of periodic libration point motion - Spatial overview at C = ' + str(c_level)
        ...
        file_name = '../../../data/animations/orbits/spatial_orbits_' + str(self.cLevel) + '.mp4'
...
if __name__ == '__main__':
    ...
    for c_level in c_levels:
        spatial_orbits_animation = SpatialOrbitsAnimation(c_level, orbit_ids)
        spatial_orbits_animation.animate()
