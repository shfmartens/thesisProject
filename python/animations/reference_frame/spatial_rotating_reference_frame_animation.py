...
class SpatialOrbitsRotatingAnimation:
    ...
    def animate(self):
        ...
        title = 'Rotating reference frame - Spatial overview at C = ' + str(c_level)
        ...
        file_name = '../../../data/animations/reference_frame/spatial_rotating_reference_frame_' + str(c_level) + '.mp4'
