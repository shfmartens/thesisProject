...
#ifndef TUDATBUNDLE_ARTIFICIALLIBRATIONPOINTLOCATIONFUNCTION3_H
#define TUDATBUNDLE_ARTIFICIALLIBRATIONPOINTLOCATIONFUNCTION3_H
 ...
 * \f]
 */
struct ArtificialLibrationPointLocationFunction3 : public ArtificialLibrationPointLocationFunction,
        public tudat::basic_mathematics::BasicFunction< double, double >
{
    ...
    ArtificialLibrationPointLocationFunction3( unsigned int aMaximumDerivativeOrder, const double thrustAcceleration )
     ...
     */
    double getInitialGuess( ) { return -1.003037581609; }
...
#endif // TUDATBUNDLE_ARTIFICIALLIBRATIONPOINTLOCATIONFUNCTION3_H
