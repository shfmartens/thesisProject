...
#ifndef TUDATBUNDLE_LIBRATIONPOINTLOCATIONFUNCTION_H
#define TUDATBUNDLE_LIBRATIONPOINTLOCATIONFUNCTION_H
...
#endif // TUDATBUNDLE_LIBRATIONPOINTLOCATIONFUNCTION_H
