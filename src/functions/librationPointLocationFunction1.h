...
#ifndef TUDATBUNDLE_LIBRATIONPOINTLOCATIONFUNCTION1_H
#define TUDATBUNDLE_LIBRATIONPOINTLOCATIONFUNCTION1_H
        ...
        public tudat::basic_mathematics::BasicFunction< double, double >
{
    ...
    LibrationPointLocationFunction1( unsigned int aMaximumDerivativeOrder )
