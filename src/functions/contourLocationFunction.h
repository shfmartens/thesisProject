...
#ifndef TUDATBUNDLE_CONTOURLOCATIONFUNCTION_H
#define TUDATBUNDLE_CONTOURLOCATIONFUNCTION_H
...
struct contourLocationFunction
{
    //! Default destructor.
    virtual ~contourLocationFunction( ) { }
...
#endif // TUDATBUNDLE_CONTOURLOCATIONFUNCTION_H
