...
#ifndef TUDATBUNDLE_ARTIFICIALLIBRATIONPOINTLOCATIONFUNCTION_H
#define TUDATBUNDLE_ARTIFICIALLIBRATIONPOINTLOCATIONFUNCTION_H
...
struct ArtificialLibrationPointLocationFunction
{
    //! Default destructor.
    virtual ~ArtificialLibrationPointLocationFunction( ) { }
...
#endif // TUDATBUNDLE_ARTIFICIALLIBRATIONPOINTLOCATIONFUNCTION_H
