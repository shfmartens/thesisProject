                                                   ...
                                                   const double maxPositionDeviationFromPeriodicOrbit, double maxVelocityDeviationFromPeriodicOrbit, const double maxPeriodDeviationFromPeriodicOrbit, const bool initialSolutionFromTextFile )
{
    ...
    std::cout << "initialOddPoints.Size: " << initialOddPoints.size() << std::endl;
    std::cout << "initialOddPoints.rows(): " << initialOddPoints.rows() << std::endl;
                       ...
                       const double maxEigenvalueDeviation )
{
    ...
    else
    {
        ...
        if (( ( librationPointNr == 2 ) && ( orbitType == "horizontal" ) ) or continuationIndex == 6  )
        {
            ...
            {
                std::cout << "\n\nEIGENPAIR DENOTING PERIODICITY DOES NOT SATISFY PERIODICITY REQUIREMENT MODULE\n\n" << std::endl;
            }
        }
        else
        {
            ...
            if (continueNumericalContinuation == false)
            {
                std::cout << "\n\nEIGENPAIR DENOTING PERIODICITY DOES NOT SATISFY PERIODICITY REQUIREMEN REAL\n\n" << std::endl;
            }
        }
