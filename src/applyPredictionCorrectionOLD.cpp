...
{
    Eigen::VectorXd outputVector(11);
              outputVector.setZero();

              outputVector.segment(0,10) = targetVector - finalVector;
              outputVector(10) = targetTime - finalTime;
                                            ...
                                            const int maxNumberOfIterations )
{
    ...
    std::cout << "Starting Map Size " << stateHistory.size() << '\n';
...
//    // ==== LEVEL I CORRECTION ======//
//    stateHistory.clear();
//    std::cout << "Starting Map Size After Clearing L1 " << stateHistory.size() << '\n';
...
//                stateHistory.clear();
//                std::cout << "Starting Map Size After Clearing for benchmarking " << stateHistory.size() << '\n';
...
//                    std::cout << "Starting Map Size At time "<< finalTimeState.second << ": " << stateHistory.size() << '\n';
