    ...
    #pragma omp parallel num_threads(4)
    {
        ...
        for (unsigned int i=1; i<=12; i++) {
            ...
            if (i ==3)
            {
                ...
                createLowThrustInitialConditions(1, "horizontal", 1, 0.01, 120.0, 0.0, 1.0, -1.552, massParameter );
            }
            if (i ==4)
            {
            ...
            if (i ==6)
           {
                ...
                createLowThrustInitialConditions(1, "horizontal", 1, 0.01, 300.0, 0.0, 1.0, -1.552, massParameter );
            }
            ...
            if (i ==7)
           {
            ...
            if (i ==9)
            {
                ...
                createLowThrustInitialConditions(2, "horizontal", 1, 0.0000, 120.0, 0.0, 1.0, -1.552, massParameter );
            }
            if (i ==10)
            {
                std::cout << "running thread 10" << std::endl;
                createLowThrustInitialConditions(2, "horizontal", 1, 0.0001, 180.0, 0.0, 1.0, -1.552, massParameter );
            }
            if (i ==11)
            {
