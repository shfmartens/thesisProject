...
//    for (int i = 1; i < 6 ; i++)
//    {
//        Eigen::Vector2d equilibriumTest = createEquilibriumLocations(i, accelerationMagnitude, alpha, "acceleration", massParameter);
...
//                createLowThrustInitialConditions(2, "horizontal", 1, 0.05, 0.0, 0.0, 1.0, -1.552, massParameter );
//            }
//            if (i ==6)
//            {
