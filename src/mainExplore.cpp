...
#pragma omp parallel num_threads(1)
{
    ...
    for (unsigned int i=0; i<1; i++) {
        ...
        if (i == 0){
            ...
            computeManifoldsAugmented(initialStateVector, orbitalPeriod, orbitIdOne, librationPointNr, orbitType, spacecraftName, thrustPointing,  massParameter, 1.0E-6, 100, 1000, true, 1.0, 1.0E-3);
